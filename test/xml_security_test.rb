...
class XmlSecurityTest < Test::Unit::TestCase
  ...
  context "XmlSecurity" do
    setup do
      @document = Cie::XMLSecurity::SignedDocument.new(Base64.decode64(response_document))
    ...
    should "should raise Fingerprint mismatch" do
      exception = assert_raise(Cie::Saml::ValidationError) do
    ...
    should "should raise Key validation error" do
      ...
      document = Cie::XMLSecurity::SignedDocument.new(response)
      base64cert = document.elements["//ds:X509Certificate"].text
      exception = assert_raise(Cie::Saml::ValidationError) do
        document.validate_doc(base64cert, false)
      end
  ...
  context "Algorithms" do
    should "validate using SHA1" do
      @document = Cie::XMLSecurity::SignedDocument.new(fixture(:adfs_response_sha1, false))
      assert @document.validate("F1:3C:6B:80:90:5A:03:0E:6C:91:3E:5D:15:FA:DD:B0:16:45:48:72")
    end

    should "validate using SHA256" do
      @document = Cie::XMLSecurity::SignedDocument.new(fixture(:adfs_response_sha256, false))
      assert @document.validate("28:74:9B:E8:1F:E8:10:9C:A8:7C:A9:C3:E3:C5:01:6C:92:1C:B4:BA")
    end

    should "validate using SHA384" do
      @document = Cie::XMLSecurity::SignedDocument.new(fixture(:adfs_response_sha384, false))
      assert @document.validate("F1:3C:6B:80:90:5A:03:0E:6C:91:3E:5D:15:FA:DD:B0:16:45:48:72")
    end

    should "validate using SHA512" do
      @document = Cie::XMLSecurity::SignedDocument.new(fixture(:adfs_response_sha512, false))
      assert @document.validate("F1:3C:6B:80:90:5A:03:0E:6C:91:3E:5D:15:FA:DD:B0:16:45:48:72")
    end
  end
  
  context "Cie::XmlSecurity::SignedDocument" do
    ...
    context "#extract_inclusive_namespaces" do
      ...
      should_eventually 'support inclusive canonicalization' do
        ...
        response = Cie::Saml::Response.new(fixture("tdnf_response.xml"))
