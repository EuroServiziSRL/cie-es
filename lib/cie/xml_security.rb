    ...
    class SignedDocument < REXML::Document
      ...
      def validate(idp_cert_fingerprint, soft = true)
        ...
        if fingerprint != idp_cert_fingerprint.gsub(/[^a-zA-Z0-9]/,"").downcase
          return soft ? false : (raise Cie::Saml::ValidationError.new("Fingerprint mismatch"))
        end
      ...
      def validate_doc(base64_cert, soft = true)
        ...
        REXML::XPath.each(sig_element, "//ds:Reference", {"ds"=>DSIG}) do |ref|
          ...
          unless digests_match?(hash, digest_value)
            return soft ? false : (raise Cie::Saml::ValidationError.new("Digest mismatch"))
          end
        end
        ...
        unless cert.public_key.verify(signature_algorithm.new, signature, canon_string)
          return soft ? false : (raise Cie::Saml::ValidationError.new("Key validation error"))
        end
